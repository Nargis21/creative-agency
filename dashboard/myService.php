...
<?php
$get_services = "SELECT * FROM orders WHERE user_email = '$email'"  ;
...
<div class="wrapper">
  ...
  <div class="page-wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="m-5 p-5">
        <h3 class="py-4 mb-4 text-center text-white fw-bold bgColor1">My Order</h3>
            ...
            ?>
              <tr>
                ...
                <?php
                  if ($service['status'] == 'Pending') :
                  ?>
                  <a href="editMyService.php?id=<?= $service['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                  <button value="deleteMyService.php?id=<?= $service['id']; ?>" class="btn btn-danger btn-sm deleteBtn">Cancel</button>
                  <?php endif; ?>
                  <?php
                  if ($service['status'] == 'Done') :
                  ?>
